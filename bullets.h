...
#include <vector> //needed for the bullets
...
private:
    Point bulletPoint;          //gives us the bullets current location
    bullet(Point bulletsPoint); //           : x(0.0), y(0.0),check(false), dead(false), wrap(false)   {};
